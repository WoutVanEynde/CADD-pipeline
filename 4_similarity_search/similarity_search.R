...
sdf <- read.SDFset("/home/wout/PhD/BPA_derivates/Generated_compounds/REINVENT4_mol2mol_filtered_selection.sdf")
...
write.table(selected_df, file = "/home/wout/selected_40_compounds.txt", row.names = FALSE, col.names = FALSE, sep = "\t")
